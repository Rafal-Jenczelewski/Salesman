...
import {postTask, postFile} from '../requests/requests'
    ...
    render() {
        return (
            <div className={"container"}>
                ...
                <p>Podaj manualnie parametry wykonywania zadania lub skorzystaj z zaproponowanych przez nas
                    wartości.</p>
                <hr/>
                <div className={"row"}>
                    <div className={"col-5 margin20"}>
                        ...
                        <div className={"form-group"}>
                            ...
                            <input type={"text"} value={this.state.population} onChange={this.populationHandler}
                                   className={"form-control"}/>
                        </div>
                        <div className={"form-group"}>
                            <label>Ilość generacji</label>
                            <input type={"text"} value={this.state.generations} onChange={this.generationsHandler}
                                   className={"form-control"}/>
                        </div>
                        <div className={"form-group"}>
                            <label>Wielkość pojedynczego zadania</label>
                            <input type={"text"} value={this.state.singleTaskSize} onChange={this.singleTaskSizeHandler}
                                   className={"form-control"}/>
                        </div>
                        <div className={"form-group"}>
                            <label>Ilość procesów</label>
                            <input type={"text"} value={this.state.processCount} onChange={this.processCountHandler}
                                   className={"form-control"}/>
                        </div>
